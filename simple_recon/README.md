This script automates the tasks like port scanning, vulnerability discovery, subdomain enumeration etc. using nmap, nikto and recon-ng. Make sure you have them installed in your system.
